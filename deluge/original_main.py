...
def login():
	...
	#builder is globally defined   
	builder.add_from_file(deluge.common.resource_filename("deluge.ui.gtkui", os.path.join("glade", "login_menu.ui")))
 ...
 #   while loggedin:
		#on login button clicked
			#username = inputfromgui
			#passwrd = inputfromgui
			#f = db.find.md5hash(pswd)
		#if f:
			#logged = False
		#else:
			#print("invalid login")
	#accesslvl = db[md5hash
